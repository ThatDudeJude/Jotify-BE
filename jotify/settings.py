"""
Django settings for jotify project.
...
ALLOWED_HOSTS = [env.str("HOSTNAME1"), env.str("FRONTENDHOST"), "127.0.0.1"]
...
WSGI_APPLICATION = "jotify.wsgi.application"
